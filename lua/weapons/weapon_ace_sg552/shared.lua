...
SWEP.MovementSpread = 3.5 --Increase aimcone to this many degrees when sprinting at full speed
...
function SWEP:InitBulletData()
	...
	self.BulletData.PenArea = self.BulletData.FrArea ^ ACE.PenAreaMod * 1.3
