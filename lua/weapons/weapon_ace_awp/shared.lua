...
SWEP.RecoilSideBias = 0.2 --How much the recoil is biased to one side proportional to vertical recoil
...
SWEP.ViewPunchAmount = 7.5 --Degrees to punch the view upwards each shot - does not actually move crosshair, just a visual effect
...
function SWEP:InitBulletData()
	...
	self.BulletData.PenArea = self.BulletData.FrArea ^ ACE.PenAreaMod * 4
