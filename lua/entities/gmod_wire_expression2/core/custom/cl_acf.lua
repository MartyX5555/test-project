...
E2Helper.Descriptions["acfInfoRestricted"] = "Returns 1 if functions returning sensitive info are restricted to owned and friends props."
E2Helper.Descriptions["acfLinks"] = "Returns all entities which are linked to this entity through ACE."
E2Helper.Descriptions["acfGetLinkedWheels"] = "Returns any wheels linked to this engine/gearbox or its children links."
E2Helper.Descriptions["acfDragDiv"] = "Returns the current ACF drag divisor."
E2Helper.Descriptions["acfHeat"] = "Returns the temperature of an ACF entity."
...
E2Helper.Descriptions["acfHEATAirGapFactor"] = "Returns the current air gap factor (air effectiveness against HEAT). Its value represents the percentage of energy remaining after 1 meter of travel."
E2Helper.Descriptions["acfWindVector"] = "Returns the current ACE wind direction vector."
--engine
E2Helper.Descriptions["acfMaxTorque"] = "Returns the peak torque of an ACF engine, in Nm."
E2Helper.Descriptions["acfMaxPower"] = "Returns the peak power of an ACF engine, in kW."
E2Helper.Descriptions["acfMaxTorqueWithFuel"] = "Returns the peak torque of an ACF engine with fuel linked, in Nm."
E2Helper.Descriptions["acfMaxPowerWithFuel"] = "Returns the peak power of an ACF engine with fuel linked, in kW."
E2Helper.Descriptions["acfIdleRPM"] = "Returns the idle RPM of an ACF engine."
E2Helper.Descriptions["acfPowerbandMin"] = "Returns the lower powerband of an ACF engine."
E2Helper.Descriptions["acfPowerbandMax"] = "Returns the upper powerband of an ACF engine."
...
E2Helper.Descriptions["acfTorque"] = "Returns the current torque of an ACF engine, in Nm."
...
E2Helper.Descriptions["acfPower"] = "Returns the current power of an ACF engine, in kW."
E2Helper.Descriptions["acfInPowerband"] = "Returns 1 if an ACF engine's RPM is within the powerband."
...
E2Helper.Descriptions["acfGetFuelTanks"] = "Returns an array of all fuel tanks linked to an ACF engine."
E2Helper.Descriptions["acfIsElectric"] = "Returns 1 if an ACF engine is electric."
...
E2Helper.Descriptions["acfTorqueRating"] = "Returns the maximum torque that an ACF gearbox can handle, in Nm."
E2Helper.Descriptions["acfIsDual"] = "Returns 1 if an ACF gearbox is dual clutch."
E2Helper.Descriptions["acfShiftTime"] = "Returns the time an ACF gearbox takes to change gears, in ms."
...
E2Helper.Descriptions["acfTorqueOut"] = "Returns the current torque output an ACF gearbox, in Nm."
E2Helper.Descriptions["acfCVTRatio"] = "Sets the gear ratio of a CVT. Set to 0 to enable automatic ratio control."
E2Helper.Descriptions["acfShift"] = "Shift to the specified gear for an ACF gearbox."
E2Helper.Descriptions["acfShiftUp"] = "Shifts an ACF gearbox up."
E2Helper.Descriptions["acfShiftDown"] = "Shifts an ACF gearbox down."
...
E2Helper.Descriptions["acfPenetration(e:)"] = "Returns the penetration of a round in an ACF ammo crate or gun."
E2Helper.Descriptions["acfPenetration(e:n)"] = "Returns the penetration of a round in an ACF ammo crate or gun, with an index to check penetration for THEAT (uses indexes 1 and 2)."
