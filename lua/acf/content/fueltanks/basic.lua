...
ACE_DefineFuelTank( "Basic_FuelTank", {
...
ACE_DefineFuelTankSize( "Tank_1x1x1", { --ID used in code
...
ACE_DefineFuelTankSize( "Tank_1x1x2", {
	name = "1x1x2",
...
ACE_DefineFuelTankSize( "Tank_1x1x4", {
	name = "1x1x4",
	desc = "Dinghy",
...
ACE_DefineFuelTankSize( "Tank_1x2x1", {
	name = "1x2x1",
	desc = "Will keep a kart running all day.",
...
ACE_DefineFuelTankSize( "Tank_1x2x2", {
	name = "1x2x2",
	desc = "Dinghy",
...
ACE_DefineFuelTankSize( "Tank_1x2x4", {
	name = "1x2x4",
	desc = "Outboard motor.",
...
ACE_DefineFuelTankSize( "Tank_1x4x1", {
	name = "1x4x1",
	desc = "Dinghy",
...
ACE_DefineFuelTankSize( "Tank_1x4x2", {
	name = "1x4x2",
	desc = "Clown car.",
...
ACE_DefineFuelTankSize( "Tank_1x4x4", {
	name = "1x4x4",
	desc = "Fuel pancake.",
...
ACE_DefineFuelTankSize( "Tank_1x6x1", {
	name = "1x6x1",
	desc = "Lawn tractors.",
...
ACE_DefineFuelTankSize( "Tank_1x6x2", {
	name = "1x6x2",
...
ACE_DefineFuelTankSize( "Tank_1x6x4", {
	name = "1x6x4",
...
ACE_DefineFuelTankSize( "Tank_1x8x1", {
	name = "1x8x1",
	desc = "Clown car.",
...
ACE_DefineFuelTankSize( "Tank_1x8x2", {
	name = "1x8x2",
...
ACE_DefineFuelTankSize( "Tank_1x8x4", {
	name = "1x8x4",
	desc = "Beep beep.",
...
ACE_DefineFuelTankSize( "Tank_2x2x1", {
	name = "2x2x1",
	desc = "Dinghy",
...
ACE_DefineFuelTankSize( "Tank_2x2x2", {
	name = "2x2x2",
	desc = "Clown car.",
...
ACE_DefineFuelTankSize( "Tank_2x2x4", {
	name = "2x2x4",
	desc = "Mini Cooper.",
...
ACE_DefineFuelTankSize( "Tank_2x4x1", {
	name = "2x4x1",
...
ACE_DefineFuelTankSize( "Tank_2x4x2", {
	name = "2x4x2",
	desc = "Mini Cooper.",
...
ACE_DefineFuelTankSize( "Tank_2x4x4", {
	name = "2x4x4",
	desc = "Land boat.",
...
ACE_DefineFuelTankSize( "Tank_2x6x1", {
	name = "2x6x1",
...
ACE_DefineFuelTankSize( "Tank_2x6x2", {
	name = "2x6x2",
	desc = "Compact car.",
...
ACE_DefineFuelTankSize( "Tank_2x6x4", {
	name = "2x6x4",
	desc = "Sedan.",
...
ACE_DefineFuelTankSize( "Tank_2x8x1", {
	name = "2x8x1",
...
ACE_DefineFuelTankSize( "Tank_2x8x2", {
	name = "2x8x2",
	desc = "Truck.",
...
ACE_DefineFuelTankSize( "Tank_2x8x4", {
	name = "2x8x4",
...
ACE_DefineFuelTankSize( "Tank_4x4x1", {
	name = "4x4x1",
	desc = "Sedan.",
...
ACE_DefineFuelTankSize( "Tank_4x4x2", {
	name = "4x4x2",
	desc = "Land boat.",
...
ACE_DefineFuelTankSize( "Tank_4x4x4", {
	name = "4x4x4",
...
ACE_DefineFuelTankSize( "Tank_4x6x1", {
	name = "4x6x1",
...
ACE_DefineFuelTankSize( "Tank_4x6x2", {
	name = "4x6x2",
	desc = "Fire juice.",
...
ACE_DefineFuelTankSize( "Tank_4x6x4", {
	name = "4x6x4",
...
ACE_DefineFuelTankSize( "Tank_4x8x1", {
	name = "4x8x1",
	desc = "Arson material.",
...
ACE_DefineFuelTankSize( "Tank_4x8x2", {
	name = "4x8x2",
...
ACE_DefineFuelTankSize( "Tank_4x8x4", {
	name = "4x8x4",
...
ACE_DefineFuelTankSize( "Tank_6x6x1", {
	name = "6x6x1",
	desc = "Got gas?",
...
ACE_DefineFuelTankSize( "Tank_6x6x2", {
	name = "6x6x2",
...
ACE_DefineFuelTankSize( "Tank_6x6x4", {
	name = "6x6x4",
...
ACE_DefineFuelTankSize( "Tank_6x8x1", {
	name = "6x8x1",
...
ACE_DefineFuelTankSize( "Tank_6x8x2", {
	name = "6x8x2",
...
ACE_DefineFuelTankSize( "Tank_6x8x4", {
	name = "6x8x4",
...
ACE_DefineFuelTankSize( "Tank_8x8x1", {
	name = "8x8x1",
	desc = "Sloshy sloshy!",
...
ACE_DefineFuelTankSize( "Tank_8x8x2", {
	name = "8x8x2",
...
ACE_DefineFuelTankSize( "Tank_8x8x4", {
	name = "8x8x4",
	desc = "Tank Tank.",
...
ACE_DefineFuelTankSize( "Fuel_Drum", {
	name = "Fuel Drum",
...
ACE_DefineFuelTankSize( "Jerry_Can", {
	name = "Jerry Can",
...
ACE_DefineFuelTankSize( "Transport_Tank", {
	name = "Transport Tank",
...
ACE_DefineFuelTankSize( "Storage_Tank", {
	name = "Storage Tank",
	desc = "Disappointingly non-explosive.",
...
ACE_DefineFuelTankSize( "Gas_Pump", {
	name = "Gas Pump",
