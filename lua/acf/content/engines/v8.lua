...
ACE.RegisterEngine( "5.7-V8", {
	...
	sound = "ace_engines/v8_petrolsmall.wav",
	category = "V8",
	fuel = "Petrol",
...
ACE.RegisterEngine( "9.0-V8", {
	...
	sound = "ace_engines/v8_petrolmedium.wav",
	category = "V8",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 400,
...
ACE.RegisterEngine( "18.0-V8", {
	...
	sound = "ace_engines/v8_petrollarge.wav",
	category = "V8",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 850,
...
ACE.RegisterEngine( "4.5-V8", {
	...
	model = "models/engines/v8s.mdl",
	sound = "ace_engines/v8_dieselsmall.wav",
	category = "V8",
	fuel = "Diesel",
...
ACE.RegisterEngine( "7.8-V8", {
	...
	model = "models/engines/v8m.mdl",
	sound = "ace_engines/v8_dieselmedium2.wav",
	category = "V8",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 520,
...
ACE.RegisterEngine( "19.0-V8", {
	...
	model = "models/engines/v8l.mdl",
	sound = "ace_engines/v8_diesellarge.wav",
	category = "V8",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 1200,
