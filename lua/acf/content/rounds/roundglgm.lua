...
function Round.guicreate( Panel, Table )
	...
	acfmenupanel:AmmoSelect( ACE.AmmoBlacklist.GLATGM )
...
function Round.guiupdate( Panel )
	...
	acfmenupanel:CPanelText("VelocityDisplay", "Command Link: " .. math.floor(Data.MuzzleVel * ACE.VelScale * 4) .. " m")	--Proj muzzle velocity (Name, Desc)
