...
Round.name  = "[HEAT] - " .. ACETranslation.ShellHEAT[1] --Human readable name
Round.model = "models/munitions/round_100mm_shot.mdl" --Shell flight model
Round.desc  = ACETranslation.ShellHEAT[2]
...
function Round.guiupdate( Panel )
	...
	local R5V, R5P = ACE.PenRanging(Data.MuzzleVel, Data.DragCoef, Data.ProjMass, Data.PenArea * ACE.HEATPlungingReduction, Data.LimitVel, 100)
	R5P = (ACE.Kinetic(Data.SlugMV * 39.37, Data.SlugMass, 999999).Penetration / Data.SlugPenArea / ACE.HEATPlungingReduction) * ACE.KEtoRHA
