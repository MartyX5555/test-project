...
Round.name = "[THEAT-FS] - " .. ACETranslation.THEATFS[1] --Human readable name
Round.model = "models/munitions/round_100mm_mortar_shot.mdl" --Shell flight model
Round.desc = ACETranslation.THEATFS[2]
...
function Round.convert( _, PlayerData )
	...
	PlayerData.ConeAng = PlayerData.ConeAng or 0
	PlayerData.ConeAng2 = PlayerData.ConeAng2 or 0
	PlayerData.HEAllocation = PlayerData.HEAllocation or 0
