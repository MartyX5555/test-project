...
ACE.AmmoBlacklist.APFSDS = { "AC", "SA","C","MG", "HMG" ,"RAC", "SC","ATR" , "MO" , "RM", "SL", "GL", "HW", "SC", "BOMB" , "GBU", "ASM", "AAM", "SAM", "UAR", "POD", "FFAR", "ATGM", "ARTY", "ECM", "FGL"}

local Round = {}

Round.type  = "Ammo" --Tells the spawn menu what entity to spawn
Round.name  = "[APFSDS] - " .. ACETranslation.ShellAPFSDS[1] --Human readable name
Round.model = "models/munitions/dart_100mm.mdl" --Shell flight model
Round.desc  = ACETranslation.ShellAPFSDS[2]
...
function Round.guicreate( Panel, Table )
	...
	acemenupanel:AmmoSelect( ACE.AmmoBlacklist.APFSDS )
