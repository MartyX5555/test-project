...
ACE.AmmoBlacklist.HE = { "MG", "SL", "ECM","ATR","SBC" }

local Round = {}

Round.type  = "Ammo" --Tells the spawn menu what entity to spawn
Round.name  = "[HE] - " .. ACETranslation.ShellHE[1] --Human readable name
Round.model = "models/munitions/round_100mm_shot.mdl" --Shell flight model
Round.desc  = ACETranslation.ShellHE[2]
...
function Round.convert( _, PlayerData )
	...
	PlayerData.FillerVol		= math.max(PlayerData.FillerVol or 0, 0) --HEFiller
	...
	Data.ProjMass		= math.max(GUIData.ProjVolume-PlayerData.FillerVol,0) * 7.9 / 1000 + math.min(PlayerData.FillerVol,GUIData.ProjVolume) * ACE.HEDensity / 1000
...
function Round.guicreate( Panel, Table )
	...
	acemenupanel:AmmoSelect(ACE.AmmoBlacklist.HE)
