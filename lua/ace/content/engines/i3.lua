...
ACE.RegisterEngine( "1.2-I3", {
	...
	sound = "ace_engines/i4_petrolsmall2.wav",
	category = "I3",
	fuel = "Petrol",
...
ACE.RegisterEngine( "3.4-I3", {
	...
	sound = "ace_engines/i4_petrolmedium2.wav",
	category = "I3",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 170,
...
ACE.RegisterEngine( "13.5-I3", {
	...
	sound = "ace_engines/i4_petrollarge.wav",
	category = "I3",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 500,
...
ACE.RegisterEngine( "1.1-I3", {
	...
	model = "models/engines/inline3s.mdl",
	sound = "ace_engines/i4_diesel2.wav",
	category = "I3",
	fuel = "Diesel",
...
ACE.RegisterEngine( "2.8-I3", {
	...
	model = "models/engines/inline3m.mdl",
	sound = "ace_engines/i4_dieselmedium.wav",
	category = "I3",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 200,
...
ACE.RegisterEngine( "11.0-I3", {
	...
	model = "models/engines/inline3b.mdl",
	sound = "ace_engines/i4_diesellarge.wav",
	category = "I3",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 650,
