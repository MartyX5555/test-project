...
ACE.RegisterEngine( "2.2-I6", {
	...
	sound = "ace_engines/l6_petrolsmall2.wav",
	category = "I6",
	fuel = "Petrol",
...
ACE.RegisterEngine( "4.8-I6", {
	...
	sound = "ace_engines/l6_petrolmedium.wav",
	category = "I6",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 300,
...
ACE.RegisterEngine( "17.2-I6", {
	...
	sound = "ace_engines/l6_petrollarge2.wav",
	category = "I6",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 850,
...
ACE.RegisterEngine( "3.0-I6", {
	...
	model = "models/engines/inline6s.mdl",
	sound = "ace_engines/l6_dieselsmall.wav",
	category = "I6",
	fuel = "Diesel",
...
ACE.RegisterEngine( "6.5-I6", {
	...
	model = "models/engines/inline6m.mdl",
	sound = "ace_engines/l6_dieselmedium4.wav",
	category = "I6",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 450,
...
ACE.RegisterEngine( "20.0-I6", {
	...
	model = "models/engines/inline6l.mdl",
	sound = "ace_engines/l6_diesellarge2.wav",
	category = "I6",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 1200,
