ACE.RegisterEngine( "3.6-V6", {
	...
	sound = "ace_engines/v6_petrolsmall.wav",
	category = "V6",
	fuel = "Petrol",
...
ACE.RegisterEngine( "6.2-V6", {
	...
	sound = "ace_engines/v6_petrolmedium.wav",
	category = "V6",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 360,
...
ACE.RegisterEngine( "5.2-V6", {
	...
	model = "models/engines/v6med.mdl",
	sound = "ace_engines/i5_dieselmedium.wav",
	category = "V6",
	fuel = "Multifuel",
...
ACE.RegisterEngine( "12.0-V6", {
	...
	sound = "ace_engines/v6_petrollarge.wav",
	category = "V6",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 675,
...
ACE.RegisterEngine( "15.0-V6", {
	...
	model = "models/engines/v6large.mdl",
	sound = "ace_engines/v6_diesellarge.wav",
	category = "V6",
	fuel = "Multifuel",
	enginetype = "GenericDiesel",
	weight = 900,
