...
ACE.RegisterEngine( "0.25-I1", {
	name = "250cc Single",
	desc = "Tiny bike engine",
	model = "models/engines/1cylsml.mdl",
	sound = "ace_engines/i1_small.wav",
	category = "Single",
	fuel = "Petrol",
