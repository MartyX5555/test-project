--define the class
ACE.RegisterWeaponClass("SC", {
	type = "Gun",
	spread = 0.20,
	name = "Short-Barrel Cannon",
	desc = ACETranslation.GunClasses[13],
