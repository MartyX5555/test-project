...
ACE.RegisterWeapon("FIM-92 SAM", {								-- id
	name             = "FIM-92 Missile",
...
ACE.RegisterWeapon("Mistral SAM", {								-- id
...
ACE.RegisterWeapon("Strela-1 SAM", {								-- id
	name             = "9M31 Strela-1",
...
--Tunguska Missile
ACE.RegisterWeapon("9M311 SAM", {										-- id
	name             = "9M311 Missile",
