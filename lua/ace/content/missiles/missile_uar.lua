...
--define the class
ACE.RegisterWeaponClass("UAR", {
	type			= "missile",
	spread		= 0.2,
	name			= "[ASR] - Unguided Aerial Rockets",
	desc			= ACETranslation.MissileClasses[9],
...
ACE.RegisterWeapon("SPG-9 ASR", { --id
	...
	ent        = "ace_rack", -- A workaround ent which spawns an appropriate rack for the missile.
	guidance   = {"Dumb"},
...
ACE.RegisterWeapon("RS82 ASR", { --id
...
ACE.RegisterWeapon("Zuni ASR", { --id
	name             = "Zuni Rocket",
...
ACE.RegisterWeapon("HVAR ASR", { --id
...
ACE.RegisterWeapon("S-24 ASR", { --id
